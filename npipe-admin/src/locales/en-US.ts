...
export default {
  ...
  dashboard: {
    ...
    config: {
      ...
      quiet: 'Quiet Mode',
      transportMaxConnections: 'Max Forward Connections',
      transportIdleTimeout: 'Forward Idle Timeout',
    },
    table: {
      id: 'ID',
      username: 'Username',
  ...
  player: {
    ...
    totalTransferTraffic: 'Total Download / Upload',
    ...
    table: {
      ...
      totalTrafficIn: 'Total Download',
      totalTrafficOut: 'Total Upload',
      actions: 'Actions',
    },
  },
