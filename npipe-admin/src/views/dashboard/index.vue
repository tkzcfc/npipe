...
const configItems = computed(() => [
  ...
  { label: t('dashboard.config.tunnelTls'), value: config.value.enable_tls ? t('common.enable') : t('common.disable') },
  { label: t('dashboard.config.webTls'), value: config.value.web_enable_tls ? t('common.enable') : t('common.disable') },
  { label: t('dashboard.config.webTlsAutoSelfSigned'), value: config.value.web_tls_auto_self_signed ? t('common.enable') : t('common.disable') },
  { label: t('dashboard.config.cookieSecure'), value: config.value.web_cookie_secure ? t('common.enable') : t('common.disable') },
